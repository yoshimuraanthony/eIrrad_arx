...
\usepackage{filecontents}  % generate sup.aux once uploaded to arXiv
...
\usepackage{lmodern}
\usepackage{xr}
\externaldocument{sup1}  % arXiv deletes all sup.* files besides sup.tex
...
\end{equation}
%
Lastly, the function Ei is the exponential integral,
...
\makeatletter\@input{maux.tex}\makeatother  % generated sup.aux
